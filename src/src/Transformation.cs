...
namespace src
{
    static class Transformation
    {
        ...
        public static void Transform(ref float x, ref float y, ref float z, double cosTetX, double sinTetX, double cosTetY, double sinTetY, double cosTetZ, double sinTetZ)
        {
            double x_tmp = x;
            double y_tmp = y;
            double z_tmp = z;
